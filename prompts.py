...
def build_action_prompt(
    ...
    user = (
        ...
        f"{feedback_line}"
        "\n"
        "Choose an action that reveals how the character is interpreting the situationw while still pushing towards goal completion."
...
def build_narrator_prompt(
    ...
    system = (
        ...
        "Maintain continuity of cause-and-effect, spatial logic, character motivations, and the physical setting, while treating emotional interpretation and relationship shifts as real story events. "
        "Do not narrate only logistics or tactical progress; show what the chosen actions mean between the characters through subtext, silence, timing, gesture, attention, avoidance, and changed perception. "
        "A scene may matter because someone hesitates, misreads another person, remembers an object differently, withholds an answer, or understands the room less simply than before. "
    ...
    user = (
        ...
        "Prefer emotional reinterpretation, relational tension, and subtext over dense procedural sequencing. "
